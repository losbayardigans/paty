...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-10-2024 a las 22:22:48
...
CREATE TABLE `pedidos_has_productos` (
  ...
  `productos_inventario_id_categoria` int(11) NOT NULL,
...
ALTER TABLE `pedidos_has_productos`
  ADD PRIMARY KEY (`pedidos_id_pedido`,`pedidos_productos_id_producto`,`pedidos_cliente_id_cliente`,`productos_id_producto`,`productos_categorias_id_categoria`,`productos_inventario_id_categoria`,`productos_Proveedor_id_Proveedor`),
  ADD KEY `fk_pedidos_has_productos_productos1_idx` (`productos_id_producto`,`productos_categorias_id_categoria`,`productos_inventario_id_categoria`,`productos_Proveedor_id_Proveedor`),
...
ALTER TABLE `pedidos_has_productos`
  ...
  ADD CONSTRAINT `fk_pedidos_has_productos_productos1` FOREIGN KEY (`productos_id_producto`,`productos_categorias_id_categoria`,`productos_inventario_id_categoria`,`productos_Proveedor_id_Proveedor`) REFERENCES `productos` (`id_producto`, `categorias_id_categoria`, `inventario_id_categoria`, `Proveedor_id_Proveedor`) ON DELETE NO ACTION ON UPDATE NO ACTION;
